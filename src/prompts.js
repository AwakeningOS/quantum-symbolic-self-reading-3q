...
5. 位相の掟(合流点): 同じ成分に二方向から流れが入る箇所では、二つの流れが強め合っているなら位相差が0に、打ち消し合っているなら位相差がπに近づくようにφを選ぶこと。合流点で位相差が±π/2(直交)になると、二つの流れは干渉せずただ足し合わされる。物語の中で「二つの力が同じ場所でぶつかる・重なる」瞬間こそ、同位相/逆位相を使う場面である。
